...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i asdad.ads -o zapis.ppm
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i opcje.c -o zapis.ppm
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -o zapis2.ppm
Dane wyjsciowe: Opcje poprawne
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -n -o zapis.pgm
Dane wyjsciowe: Opcje poprawne
Rezultat: Program dziala poprawnie.

Test 5.1:
Cel: Sprawdzenie poprawnosci dzialania funkcji negatyw dla pliku o formacie PPM
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -n -o zapis.ppm
Dane wyjsciowe: Opcje poprawne
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -k -o zapis.pgm
Dane wyjsciowe: Opcje poprawne
Rezultat: Program dziala poprawnie 

Test 6.1:
Cel: Sprawdzenie poprawnosci dzialania funkcji konturowanie dla pliku o formacie PPM
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -k -o zapis.ppm
Dane wyjsciowe: Opcje poprawne
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -p 50 -o zapis.pgm
Dane wyjsciowe: Opcje poprawne
Rezultat: Program dziala poprawnie

Test 7.1:
Cel: Sprawdzenie poprawnosci dzialania funkcji polprogowanie bieli dla pliku o formacie PPM
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -p 50 -o zapis.ppm
Dane wyjsciowe: Opcje poprawne
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -d -o zapis.ppm
Dane wyjsciowe: display kubus.ppm & | Opcje poprawne
Rezultat: Program dziala poprawnie

Test 9:
Cel: Sprawdzenie poprawnosci dzialania funkcji splot
Dane wesjciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -s (s1/s2/s3/s4/s5/s6/s7) -o zapis.ppm
...
6. splot
7. zapisanie obrazu
Dane wejsciowe: ./przetwarzanieObrazowV2 -i kubus.ppm -n -k -p 50 -o zapis.ppm
Dane wyjsciowe: Opcje poprawne.
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i 
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -o -
Dane wyjsciowe: 
P2
20 10
8
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -u
...
Dane wejsciowe: ./przetwarzanieObrazowV2 -i maly_2.pgm -p -o zapis.pgm
